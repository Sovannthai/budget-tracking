    ...
    <div class="row">
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="income-details">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-bold">
                                    @if($row->expenseType && $row->expenseType->icon)
                                        <span class="me-1">{{ $row->expenseType->icon }}</span>
                                    @endif
                                    {{ optional($row->expenseType)->name }}
                                </span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="d-flex justify-content-center">
                            @include('backend.components.table.action_btn', [
                                'route_delete'   => 'expenses.destroy',
                                'route_edit'     => 'expenses.edit',
                                'row'            => $row,
        ...
        @empty
            <div class="col-12 text-center py-5">
                <h4 class="text-muted">@lang('No Expenses types found')</h4>
            </div>
        @endforelse
    </div>
    @if (count($expenses) != 0)
        @include('backend.components.table.paginate', ['items' => $expenses])
    @endif
</div>