<style>
    /* Modern styling for income management */
    .card {
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            const savedView = localStorage.getItem('incomePreferredView');
            if (savedView === 'grid') {
                showGridView();
            } else {
                showTableView();
            ...
            $(window).resize(function() {
                if ($(window).width() < 768) {
                    ...
                    if (!localStorage.getItem('incomePreferredView')) {
                        showGridView();
                    }
                }
            });
            ...
            $('#table-view-btn').click(function() {
                showTableView();
                localStorage.setItem('incomePreferredView', 'table');
            });

            $('#grid-view-btn').click(function() {
                showGridView();
                localStorage.setItem('incomePreferredView', 'grid');
            });
