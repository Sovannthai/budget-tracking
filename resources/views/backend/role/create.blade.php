                    ...
                    <div class="card mt-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            @include('backend.components.table.header_table', [
                                ...
                                'header_text'      => __('Create Role'),
                                'sub_header_title' => __('Fill in the details below to create a new role'),
                            ])
                        </div>
                        <form class="form-material form-horizontal" action="{{ route('role.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" id="name" name="name"
                                                    ...
                                                    placeholder="@lang('Type name permission')" required>
                                                @error('name')
                                ...
                                <div>
                                    <div class="" hidden>
                                        ...
                                        <div class="toggler">
                                            <input id="toggler-1" name="select-all" type="checkbox">
                                            <label for="toggler-1">
                                        ...
                                        <span class="mt-1" style="margin-left: 5px;">Select All</span>
                                    </div><br>
                                    <div class="row">
                                        @foreach ($permissions as $permission => $permissionList)
                                            <div class="col-sm-12">
                                                <label class="mr-2"><b>{{ ucwords($permission) }}</b></label><br>
                                                <div class="row">
                                                    @foreach ($permissionList as $perm)
                                                        <div class="form-group col-sm-3">
                                                            <div class="input-group">
                                                                <div class="toggler">
                                                                    <input id="toggler-{{ $perm->id }}"
                                                                        name="permissions[]" type="checkbox"
                                                                        value="{{ $perm->id }}">
                                                                    <label for="toggler-{{ $perm->id }}">
